...
class GetMainTasksByWeekDaysUsecase extends UseCaseWithParams<MainTaskEntity,
    MainTaskRepository, List<MainTaskEntity>, List<int>> {
  GetMainTasksByWeekDaysUsecase(super.repository);
