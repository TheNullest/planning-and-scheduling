...
ThemeData darkMode = ThemeData(
  ...
  /// Selected tab indicator and icon
  surfaceTint: Color.fromRGBO(127, 177, 252, 1),

  /// Unselected tab indicator and icon
  surfaceVariant: Color.fromRGBO(104, 103, 103, 1),

  /// icon's shadow
  onSurfaceVariant: Color.fromRGBO(255, 255, 255, .3),
));
