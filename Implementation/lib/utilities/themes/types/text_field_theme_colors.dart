...
class TextFieldThemeColors {
  ...
  TextFieldThemeColors lerp(TextFieldThemeColors? other, t) => other == null
      ? this
      : TextFieldThemeColors(
          ...
          textFieldEnabledBorderColor: Color.lerp(textFieldEnabledBorderColor,
              other.textFieldEnabledBorderColor, t)!,
          textFieldFocusedBorderColor: Color.lerp(textFieldFocusedBorderColor,
              other.textFieldFocusedBorderColor, t)!,
        );
}
