...
/// push [CustomDatePickerWidget] when the button is tapped.
///
...
Future<DateTime?> showDatePicker({
  ...
  Widget dialog = CustomDatePickerWidget(
...
/// This is accomplished by enabling state restoration by specifying
/// [MaterialApp.restorationScopeId] and using [Navigator.restorablePush] to
/// push [CustomeDateRangePickerWidget] when the button is tapped.
///
...
Future<DateTimeRange?> showDateRangePicker({
  ...
  Widget dialog = CustomeDateRangePickerWidget(
...
class CustomeDateRangePickerWidget extends StatefulWidget {
  /// A Material-style date range picker dialog.
  const CustomeDateRangePickerWidget({
    super.key,
  ...
  /// Restoration ID to save and restore the state of the [CustomeDateRangePickerWidget].
  ///
  ...
  @override
  State<CustomeDateRangePickerWidget> createState() =>
      _CustomeDateRangePickerWidgetState();
}

class _CustomeDateRangePickerWidgetState
    extends State<CustomeDateRangePickerWidget> with RestorationMixin {
  late final _RestorableDatePickerEntryMode _entryMode =
      _RestorableDatePickerEntryMode(widget.initialEntryMode);
