...
//TODO #4 Resolve and fix all CustomTimePickerWidget warnings
...
/// See also:
///
/// * [showTimePicker], a function that shows a [CustomTimePickerWidget] and returns
...
/// [Navigator.pop].
///
/// Use [showTimePicker] to show a dialog already containing a [CustomTimePickerWidget].
class CustomTimePickerWidget extends StatefulWidget {
  ...
  final DateTimeHelper selectedTime;
  ...
  /// Restoration ID to save and restore the state of the [CustomTimePickerWidget].
  ///
...
class _CustomTimePickerWidgetState extends State<CustomTimePickerWidget>
    with RestorationMixin {
  late final TimeOfDay selectedTime = TimeOfDay(
      hour: widget.selectedTime.hour, minute: widget.selectedTime.minute);
  ...
  void _handleTimeChanged(TimeOfDay value) {
    if (value != _selectedTime.value) {
      setState(() {
        _selectedTime.value = value;
        widget.selectedTime.hour = value.hour;
        widget.selectedTime.minute = value.minute;
...
Future<TimeOfDay?> showTimePicker({
  ...
  required DateTimeHelper selectedTime,
  ...
  final Widget dialog = CustomTimePickerWidget(
