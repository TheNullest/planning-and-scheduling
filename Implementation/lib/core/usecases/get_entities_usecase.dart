...
abstract class GetEntitiesUseCase<Repo extends BaseRepositoryAbstraction,
        Entity extends BaseEntityAbstraction>
    extends UseCaseWithoutParams<Repo, List<Entity>> {
  GetEntitiesUseCase(super.repository);
  @override
  ResultFuture<List<Entity>> call() async =>
      await repository.getEntities() as ResultFuture<List<Entity>>;
}
