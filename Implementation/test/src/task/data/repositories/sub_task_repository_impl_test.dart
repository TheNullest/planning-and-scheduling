...
import 'package:zamaan/features/task/data/repositories/sub_task_repository_impl.dart';
...
void main() {
  ...
  setUp(() {
    ...
    model = HiveSubTaskModel.fromEntity(entity);
  });
  ...
  group('createEntity', () {
    test(
      ...
      when(() => mockDataSource.createEntity(
              newEntity: HiveSubTaskModel.fromEntity(entity)))
