...
import 'package:zamaan/features/task/data/repositories/goal_repository_impl.dart';
...
void main() {
  ...
  setUp(() {
    ...
    model = HiveGoalModel.fromEntity(entity);
  });
  ...
  group('createEntity', () {
    test(
      ...
      when(() => mockDataSource.createEntity(
              newEntity: HiveGoalModel.fromEntity(entity)))
