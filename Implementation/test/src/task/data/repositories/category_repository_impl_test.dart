...
import 'package:zamaan/features/task/data/repositories/category_repository_impl.dart';
...
void main() {
  ...
  setUp(() {
    ...
    model = HiveCategoryModel.fromEntity(entity);
  });
  ...
  group('createEntity', () {
    test(
      ...
      when(() => mockDataSource.createEntity(
              newEntity: HiveCategoryModel.fromEntity(entity)))
