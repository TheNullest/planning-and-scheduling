...
import 'package:zamaan/features/task/domain/usecases/scheduled_time_usecases/update_scheduled_time_usecase.dart';

import '_scheduled_time_repository.mock.dart';

void main() {
  // Arrange
  late UpdateScheduledTimeUsecase useCase;
  late ScheduledTimeRepository repository;
  setUp(() {
    repository = MockScheduledTimeRepo();
    useCase = UpdateScheduledTimeUsecase(repository);
  });

  ScheduledTimeEntity params = ScheduledTimeEntity.empty();
  // Assert
  test(
